        ...
        <div class="dashboard">
            ...
            <div class="dashboard-content">
                ...
                <div class="dashboard-title">
                    <h2>Pending leave</h2>
                    <h3><a href="dashboard.php">Dashboard</a> | Pending Leave</h3>
                </div>
                        ...
                        <table class="user-table">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT leavedetail.id, employee.employeeid, employee.fname, employee.lname, leavedetail.ltype, leavedetail.regdate 
                                        FROM leavedetail JOIN employee ON leavedetail.emp_email = employee.email WHERE leavedetail.status = 0 
                                ...
                                if ($total > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($data)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="color: blue; display: flex; gap: 3px;">Pending <span
                                                        class="material-symbols-rounded">pending</span></span></td>
                                            <td class="actionbtn">
