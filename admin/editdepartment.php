        ...
        <div class="dashboard">
            ...
            <div class="dashboard-content">
                ...
                <div class="form-container">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF'] . "?id=$id" ?>" method="POST">
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" class="form-control" id="dname" name="dname" value="<?php echo $result3['dname'] ?>"
                                placeholder="Enter Department Name">
                        </div>

                        <div class="input-field">
                            <label for="shortform">Last Name</label>
                            <input type="text" class="form-control" id="shortform" name="shortform" value="<?php echo $result3['shortform'] ?>"
                                placeholder="Enter Shortform">
                        </div>

                        <div class="input-field">
                            <label for="code">Code</label> 
                            <input type="text" class="form-control" id="code" name="code" value="<?php echo $result3['code'] ?>"
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
                    ...
                    if(!empty($dname) && !empty($shortform) && !empty($code)){
                        $sql= "UPDATE department SET dname='$dname', shortform='$shortform', code='$code' WHERE id='$id'";
