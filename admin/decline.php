        ...
        <div class="dashboard">
            ...
            <div class="dashboard-content">
                ...
                <div class="dashboard-title">
                    <h2>Decline leave</h2>
                    <h3><a href="dashboard.php">Dashboard</a> | Decline Leave</h3>
                </div>
                        ...
                        <table class="user-table">
                            ...
                            <?php
                                $sql = "SELECT leavedetail.id, employee.employeeid, employee.fname, employee.lname, leavedetail.ltype, leavedetail.regdate 
                                        FROM leavedetail JOIN employee ON leavedetail.emp_email = employee.email WHERE leavedetail.status = 2 
                                ...
                                if ($total > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($data)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><span style="color: red; display: flex; gap: 3px;">Decline <span
                                                        class="material-symbols-rounded">cancel</span></span></td>
                                            <td class="actionbtn">
